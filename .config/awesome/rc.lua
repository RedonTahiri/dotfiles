...
beautiful.init(gears.filesystem.get_configuration_dir() .. "default/mytheme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, bg='#2E3440' .. "55" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
			...
			volume_widget(),
            battery_widget({show_current_level = true, margin_left = 5, margin_right = 5}),
            mytextclock,
            s.mylayoutbox,
        },
    }
